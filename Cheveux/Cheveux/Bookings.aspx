            ...
            <div class="jumbotron bg-dark text-white">
                ...
                <div runat="server" id="JumbotronLogedOut">
                    <div class="row">
                        ...
                        <div class="col-2">
                            <button type="button" class="btn btn-primary"><a class="btn btn-primary" href="../Authentication/Accounts.aspx?PreviousPage=Bookings.aspx" id="LogedOut">Login</a></button>
                        </div>
                    </div>
                </div>
            </div>
