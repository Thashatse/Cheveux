                        ...
                        <div class="jumbotron bg-dark text-white vertical-center">
                            ...
                            <br />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <!--Validation-->
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtFirstName" runat="server" ErrorMessage="*First Name is Required" ControlToValidate="txtFirstName" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-1"></div>
                                    <div class="col-4">
                                        <!--Validation-->
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatortxtLastName" runat="server" ErrorMessage="*Last Name is Required" ControlToValidate="txtLastName" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-1"></div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <!--Help-->
                                        <a href="../Help/CheveuxHelpCenter.aspx#002" target="_blank" title="This is used to identify you on the Cheveux platform">
                                            <span class="glyphicon">&#63;</span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9 text-left">
                                        <!--Validation-->
                                       <asp:RegularExpressionValidator ID="RegularExpressionValidatortxtUsername" runat="server" ErrorMessage="Sorry, your username must be between 6 and 30 charates long" ValidationExpression="^[\s\S]{6,30}$" ControlToValidate="txtUsername" ForeColor="Red"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <!--input -->
                                       <asp:TextBox CssClass="form-control" ID="txtEmailAddress" runat="server" AutoPostBack="true"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <!--Help-->
                                        <a runat="server" id="contactNoToolTip" href="../Help/CheveuxHelpCenter.aspx#003" target="_blank" title="10-digit RSA Cellphone number used is contact you and keep you up to date">
                                            <span class="glyphicon">(Optional)</span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9 text-left">
                                        <!--Validation-->
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidatortxtPassword" runat="server" ErrorMessage="Sorry, please use 8 or more characters with a mix of letters, numbers & symbols" ValidationExpression="^.*(?=.{8,})(?=.*[\d])(?=.*[\W]).*$" ControlToValidate="txtPassword" ForeColor="Red"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
